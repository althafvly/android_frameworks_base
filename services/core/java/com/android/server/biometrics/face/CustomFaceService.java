...
public class CustomFaceService {
    ...
    private Intent getServiceIntent() {
        Intent intent = new Intent("com.spiceos.faceunlock.BIND");
        intent.setComponent(ComponentName.unflattenFromString(
                "com.spiceos.faceunlock/com.spiceos.faceunlock.service.FaceAuthService"));
        return intent;
    }

    public String getServicePackageName() {
        return "com.spiceos.faceunlock";
    }
